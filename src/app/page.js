  ...
  return (
    <>
      ...
      <section className={estilos.secao_depoimentos}>
        ...
        <div className={estilos.container_depoimentos}>
          <CardDepoimento
            ...
            nome={"Alberto"}
            descricao={
              "Por dois anos, eu fiz um tratamento com o Dentes Saudáveis, que me atendeu com profissionalismo e cuidado."
            }
          />
          <CardDepoimento
            imagem={Cliente02}
      ...
      <footer className={estilos.rodape}>
        <div>© Copyright 2024 | Consultório dentes saudáveis - Desenvolvido por Maicon Botelho</div>
      </footer>
    </>
  );
}
